    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <img src="<?=base_url()?>assets/ver3.0/images/eappraisal.png" alt="Performation Management eAppraisal Matrix" class="pull-left" />
          <a class="navbar-brand" href="#">Performation Management eAppraisal Matrix</a>
        </div>
...
{% endhighlight %}
       ...
       <div id="footer">
        <div class="container">
            <div class="devider">
              <strong>&copy; crackerjack 2013</strong>
            </div>
            </div>
        </div>
       </div>
