...
<legend><i class="custom-icon-<?=$data['permission']['url']?> pull-left"></i> Question Manager <br> <small>Create group of question</small></legend>
...
<!--
<div class="pull-left">
	<ul class="nav nav-list nav-custom" id="question-category">
		<li class='nav-header'>Question Group</li>
...
<div class="pull-left col-md-10" style="padding: 0;border-left: 1px solid #ddd;">
	//-->
